...
class Installer
{
	...
	static function init() {
		if(!file_exists(self::$basedir.'/skins/components/bower/bootstrap/dist/css/bootstrap.min.css')
			|| !file_exists(self::$basedir.'/skins/components/bower/bootstrap/dist/css/bootstrap-theme.min.css')
	...
	static function copyFile($file) {
		if(!file_exists(self::$basedir.$file)) {
			if(!file_exists(self::$installDir.'/'.$file)) {
				...
				if(file_put_contents(self::$basedir.$file, $temp)) {
