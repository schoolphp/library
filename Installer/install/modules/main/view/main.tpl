<style>
	...
	header div {position:absolute;top: 259px;left: 41%;font-family: Georgia sans-serif;font-size: 30px;color: #605C5D;font-style: oblique;}
...
<hr>
<h1>На этой странице есть стили, потому что они прописаны в main.tpl :) На остальных страницах (не админки) стилей не будет! Очищайте этот файл и наполняйте информацией, которая должна быть у Вас на сайте!</h1>
<hr>